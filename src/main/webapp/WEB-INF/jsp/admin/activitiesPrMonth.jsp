...
<html>
  ...
  <form method ="POST" action="activitiesPrMonth.htm" >
    ...
    <p>Kategori: <input type="text" name="CategoryName" /> Kun tallverdier? <input type="checkbox" name="number" value="1" /> Synlig i �rsoversikt? <input type="checkbox" name="visible" value="1" />
    <input type="hidden" name="Year" value="${Year}" >
    <input type="hidden" name="Month" value="${Month}" >
